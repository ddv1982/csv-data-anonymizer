  ...
  return {
    ...
    evidenceProfile: {
      ...
      semanticDecision: {
        ...
        supportingEvidence: ['fixture'],
        conflictingEvidence: [],
        reason: 'Fixture contact evidence.',
      },
      privacyDecision: {
        risk: piiRisk,
        recommendedStrategy: piiRisk === 'high' || piiRisk === 'medium' ? 'redact' : 'auto',
        autoSelected: piiRisk === 'high' || piiRisk === 'medium',
        reason: 'Fixture privacy decision.',
      },
      redactionDecision: {
        placeholder: '[EMAIL]',
        source: 'typed',
        ...
        reason: 'Fixture redaction decision.',
      },
    },
    evidenceDisposition: piiRisk === 'high' || piiRisk === 'medium' ? 'detectedSensitive' : 'testedBenign',
    piiRisk,
    sampleValues: ['sample'],
