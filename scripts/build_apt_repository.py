#!/usr/bin/env python3
"""Build a static signed APT repository from CSV Anonymizer .deb artifacts."""
...
DEFAULT_PACKAGE = "csv-anonymizer"
DEFAULT_COMPONENT_ID = "io.github.ddv1982.csv-data-anonymizer"
DEFAULT_ORIGIN = "csv-anonymizer-stable-main"
DEFAULT_LABEL = "CSV Anonymizer"
DEFAULT_DESCRIPTION = "CSV Anonymizer APT repository"
DEFAULT_REPOSITORY_URL = "https://ddv1982.github.io/csv-data-anonymizer/apt/"
DEFAULT_SETUP_PACKAGE_NAME = "csv-anonymizer-repository-setup"
DEFAULT_SETUP_PACKAGE_VERSION = "1.0"
DEFAULT_SETUP_MAINTAINER = "Douwe de Vries <douwe.de.vries.82@gmail.com>"
DEFAULT_SETUP_KEYRING_PATH = "/usr/share/keyrings/csv-anonymizer-archive-keyring.pgp"
DEFAULT_SETUP_SOURCES_PATH = "/etc/apt/sources.list.d/csv-anonymizer.sources"
...
def build_setup_package(args: argparse.Namespace, architectures: list[str]) -> None:
    ...
    control = (
        ...
        "Description: CSV Anonymizer APT repository setup package\n"
        " Installs the CSV Anonymizer archive keyring and Deb822 source configuration.\n"
    ).encode("utf-8")
    write_deb_archive(
...
def build_repository(args: argparse.Namespace) -> None:
    ...
    for source in expand_deb_inputs(args.deb):
        ...
        pool_rel = pathlib.PurePosixPath("pool/main/c/csv-anonymizer") / normalized_pool_filename(fields)
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build a signed CSV Anonymizer APT repository.")
